...
let anjing1 = new Anjing("Doggy", "Guk guk");
let anjing2 = new Anjing("Bruno", "Woof");

let kucing1 = new Kucing("Kitty", "Meong");
let kucing2 = new Kucing("Milo", "Miaw");

let semuaHewan = [anjing1, anjing2, kucing1, kucing2];
